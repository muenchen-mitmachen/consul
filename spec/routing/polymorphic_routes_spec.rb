...
describe "Polymorphic routes" do
  ...
  describe "admin_polymorphic_path" do
    ...
    it "routes budget investments" do
      ...
      expect(admin_polymorphic_path(investment, action: :edit)).to eq(
    ...
    it "routes budget groups" do
      ...
      expect(admin_polymorphic_path(group, action: :edit)).to eq(
    ...
    it "routes budget headings" do
      ...
      expect(admin_polymorphic_path(heading, action: :edit)).to eq(
    ...
    it "routes milestones for resources with hierarchy" do
      ...
      expect(admin_polymorphic_path(milestone, action: :edit)).to eq(
        edit_admin_budget_budget_investment_milestone_path(budget, investment, milestone)
      )
    end
    ...
    it "routes progress bars for resources with no hierarchy" do
      ...
      expect(admin_polymorphic_path(progress_bar, action: :edit)).to eq(
        edit_admin_proposal_progress_bar_path(proposal, progress_bar)
      )
    end
    ...
    it "routes progress_bars for resources with hierarchy" do
      ...
      expect(admin_polymorphic_path(progress_bar, action: :edit)).to eq(
        edit_admin_budget_budget_investment_progress_bar_path(budget, investment, progress_bar)
      )
    end
